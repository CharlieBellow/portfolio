    ...
    <>
      ...
      <div className='text-text flex flex-wrap items-start gap-6 px-6 bg-bgDark lg:w-full  w-full mx-8 h-auto my-7 justify-center '>
        ...
        <div className='items-center flex justify-center flex-col flex-1 bg-[#222] rounded-lg p-4'>
          ...
          <p className='lg:text-3xl text-action py-4'>
          ...
          <p className='lg:text-2xl px-9 text-xs'>
            ...
            Será desenvolvido em conjunto com a equipe de desenvolvimento da
            Gerência de Tecnologia da Informação (GTI) da qual faço parte.
            Utilizaremos React, Next, Typescript, Radix, Chakra, Tailwindcss,
            ente outras tecnologias. A parte gráfica já foi desenvolvida em
            grande parte por mim no{' '}
            <a
        ...
        <div className='items-center flex justify-center flex-col flex-1 bg-[#222] rounded-lg p-4'>
          ...
          <p className='lg:text-3xl text-action py-4'>List Tudo</p>
          <p className='lg:text-2xl px-9 text-xs'>
