...
export default function CardReact({
  ...
  return (
    <div className="text-bgDark flex flex-col p-4 m-2 w-full lg:h-96 h-60  gap-4 ">
      <div className="flex sm:justify-between flex-col sm:flex-row items-center gap-2">
        <span className="font-extrabold text-xl 2xl:text-2xl flex text-justify">
          {title}
        </span>
      ...
      <div className="overflow-scroll lg:flex gap-4 justify-between items-center">
        ...
        <p className="text-xs font-medium text-justify md:text-base lg:w-1/2 2xl:text-xl overflow-scroll p-4 h-full" >
          {description}
        </p>
      </div>
    </div>
